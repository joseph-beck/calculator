 ...
 * @author Dave Cohen
 */
public class CalculatorView extends Application implements ViewInterface {
  ...
  public void addTypeObserver(Consumer<OperationType> c) {
    infixCalculatorButton.setOnAction(event -> c.accept(OperationType.STANDARD));
    revPolishCalculatorButton.setOnAction(event -> c.accept(OperationType.REVERSE_POLISH));
  }
  ...
  public void start(Stage primaryStage) throws IOException {
    GridPane page = (GridPane) FXMLLoader.load(CalculatorView.class.getResource("View.fxml"));
  ...
  private static volatile CalculatorView instance = null;
   ...
   */
  public static synchronized CalculatorView getInstance() {
    if (instance == null) {
